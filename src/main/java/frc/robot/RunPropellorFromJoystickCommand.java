...
public class RunPropellorFromJoystickCommand extends CommandBase {
  /** Creates a new RunPropellorFromJoystickCommand. */
  public RunPropellorFromJoystickCommand() {
    // Use addRequirements() here to declare subsystem dependencies.
    addRequirements(RobotContainer.propellorSubsystem);
  }

  // Called when the command is initially scheduled.image.png
  @Override
